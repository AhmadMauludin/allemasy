    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('pertemuan/update/' . $pertemuan['id_pertemuan']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label>Jadwal</label>
                    <select name="id_jadwal" class="form-select" disabled>
                ...
                <a href="<?= base_url('jadwal/detail/' . $id_jadwal) ?>" class="btn btn-secondary">Kembali</a>
            </form>
        </div>
    </div>
</div>
