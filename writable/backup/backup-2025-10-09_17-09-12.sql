...
INSERT INTO `tb_kelas` VALUES (1,'X A','1',8,1,'Kelas X A','aktif','1760023025_2536b5b99833530e5ef9.jpg');
...
CREATE TABLE `tb_pertemuan` (
  ...
  `status` enum('hadir','tugas','alfa') DEFAULT 'hadir',
  `ket` text DEFAULT NULL,
...
CREATE TABLE `tb_presensi` (
  ...
  `id_pesdik` int(11) NOT NULL,
  `status` enum('hadir','sakit','ijin','alfa') DEFAULT 'hadir',
  `ket` text DEFAULT NULL,
  `foto` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-10-10  0:09:13
