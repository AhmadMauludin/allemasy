...
CREATE TABLE `tb_kelas` (
  ...
  `jenis_kelas` enum('sekolah','pesantren','ekstrakurikuler') NOT NULL,
...
INSERT INTO `tb_kelas` VALUES (1,'XI A','sekolah','5',8,1,'Kelas XI A','aktif','1760023025_2536b5b99833530e5ef9.jpg'),(2,'Lima','pesantren','5',8,1,'ngaji uuy','aktif','1760461450_383782a564c5bd8110ce.png');
...
INSERT INTO `tb_kelas_pesdik` VALUES (1,1,3,'0000-00-00','aktif'),(2,1,4,'0000-00-00','aktif'),(12,2,3,'2025-10-15','aktif');
...
INSERT INTO `tb_kompetensi` VALUES (1,'hafalan',1,1,'aktif','Harus menghafal secara sempurna','1760425878_2c5968a31567729a682c.jpg','2025-10-14 07:11:18','2025-10-14 07:11:18'),(2,'lughotan',1,1,'aktif','Harus menghafal secara sempurna',NULL,'2025-10-14 07:45:14','2025-10-22 09:48:18');
...
CREATE TABLE `tb_pembayaran` (
  ...
  `id_pesdik` int(11) NOT NULL,
  `status_pembayaran` enum('belum dibayar','dibayar','ditolak') DEFAULT 'belum dibayar',
  `metode` enum('tunai','transfer') DEFAULT NULL,
...
--
-- Table structure for table `tb_presensi_sholat`
--

DROP TABLE IF EXISTS `tb_presensi_sholat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_presensi_sholat` (
  `id_presensi_sholat` int(11) NOT NULL AUTO_INCREMENT,
  `id_sholat` int(11) NOT NULL,
  `id_pesdik` int(11) NOT NULL,
  `waktu_presensi` datetime DEFAULT NULL,
  `status_presensi` enum('pending','hadir','telat','alfa','izin','sakit') DEFAULT 'pending',
  `ket_presensi` text DEFAULT NULL,
  PRIMARY KEY (`id_presensi_sholat`),
  KEY `id_sholat` (`id_sholat`),
  KEY `id_pesdik` (`id_pesdik`),
  CONSTRAINT `tb_presensi_sholat_ibfk_1` FOREIGN KEY (`id_sholat`) REFERENCES `tb_sholat` (`id_sholat`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_presensi_sholat_ibfk_2` FOREIGN KEY (`id_pesdik`) REFERENCES `tb_pesdik` (`id_pesdik`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_presensi_sholat`
--

LOCK TABLES `tb_presensi_sholat` WRITE;
/*!40000 ALTER TABLE `tb_presensi_sholat` DISABLE KEYS */;
INSERT INTO `tb_presensi_sholat` VALUES (3,2,3,NULL,'izin',''),(4,2,4,'2025-10-15 16:32:11','hadir','');
/*!40000 ALTER TABLE `tb_presensi_sholat` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_sholat` (
  `id_sholat` int(11) NOT NULL AUTO_INCREMENT,
  `hari` varchar(10) NOT NULL,
  `tanggal` date NOT NULL,
  `sholat` enum('Shubuh','Dhuhur','Ashar','Maghrib','Isya','Lainnya') NOT NULL,
  `waktu_mulai` time NOT NULL,
  `waktu_selesai` time NOT NULL,
  `status_sholat` enum('dijadwalkan','selesai') DEFAULT 'dijadwalkan',
  `ket_sholat` text DEFAULT NULL,
...
INSERT INTO `tb_sholat` VALUES (2,'Rabu','2025-10-15','Ashar','16:29:00','16:35:00','selesai','');
...
CREATE TABLE `tb_tabungan` (
  ...
  `status_transaksi` enum('pending','disetujui','ditolak') DEFAULT 'pending',
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id_tabungan`),
  KEY `id_pesdik` (`id_pesdik`),
  KEY `verifikator` (`verifikator`),
  CONSTRAINT `tb_tabungan_ibfk_1` FOREIGN KEY (`id_pesdik`) REFERENCES `tb_pesdik` (`id_pesdik`) ON DELETE CASCADE,
  CONSTRAINT `tb_tabungan_ibfk_2` FOREIGN KEY (`verifikator`) REFERENCES `tb_user` (`id_user`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `tb_tabungan` WRITE;
/*!40000 ALTER TABLE `tb_tabungan` DISABLE KEYS */;
INSERT INTO `tb_tabungan` VALUES (1,3,'2025-10-16 22:09:27','setor',200000.00,'Kitu weh',NULL,1,'disetujui','2025-10-16 22:09:27','2025-10-16 22:16:29'),(2,4,'2025-10-16 22:12:01','setor',500000.00,'Kitu weh',NULL,1,'disetujui','2025-10-16 22:12:01','2025-10-16 22:16:20'),(3,3,'2025-10-16 22:17:15','tarik',50000.00,'kanggo meser seblak','1760627835_306de682164236c68236.jpg',1,'disetujui','2025-10-16 22:17:15','2025-10-16 22:17:57');
...
-- Dump completed on 2025-10-22 17:39:19
